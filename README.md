...
An APK is available in the releases section for you to check out the workable UI and functionality.

## Architecture and Technical Guide

For information regarding the architecture and technical details of the application, please refer to the [Architecture and Technical Details Guide](docs/architecture.md).
